...
> \*\*AIML Internship - Task 2: Comprehensive Exploratory Data Analysis\*\*
...
df = pd.read\_csv('Titanic-Dataset.csv')
...
│   └── Titanic\_EDA.ipynb            # Jupyter notebook with analysis

│

├── src/

│   └── titanic\_eda.py               # Main Python script
...
│   ├── survival\_analysis/           # Survival rate plots
...
│   └── EDA\_Report.pdf               # Detailed analysis report
